...
const placeholderStyles = {
    paddingLeft:"24px", textTransform:"uppercase",color:"gray"
}
...
export function FormArea({...props}){
    return(
        <FormControl position="relative" {...props}>
            ...
            <Button position="absolute" right="0" textDecorationColor="secondary" textDecorationThickness={"2px"}>send message</Button>
        </FormControl>
    )
}   